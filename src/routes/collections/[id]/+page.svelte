		...
		{#if collectionData.series}
			<div class="display-field">
				...
				<span class="data-value"
					><a href="/series/{collectionData.seriesId}">{collectionData.series.title}</a></span
				>
			</div>
		{/if}
		{#if collectionData.term != null}
			<div class="display-field">
				<span class="data-label">年度</span>
				<span class="data-value">{collectionData.term}</span>
			</div>
		{/if}
